...
EGIT_REPO_URI="git://github.com/cuklev/taffybar.git"
EGIT_BRANCH="kbd"
...
RDEPEND="dev-haskell/cairo:=[profile?]
    >=dev-haskell/enclosed-exceptions-1.0.0.1
	>=dev-haskell/safe-0.3 <dev-haskell/safe-1
...
PATCHES=("${FILESDIR}"/${PN}-0.2.1-haddock-2.10.0.patch
	"${FILESDIR}"/${PN}-0.3.0-haddock-utf-8.patch
)
